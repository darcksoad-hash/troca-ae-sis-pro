...
CREATE TABLE IF NOT EXISTS delivery_settings (
  ...
  price_per_km DOUBLE PRECISION NOT NULL DEFAULT 2.5,
  minimum_fee DOUBLE PRECISION NOT NULL DEFAULT 10,
  free_radius_km DOUBLE PRECISION NOT NULL DEFAULT 0,
  notes TEXT
);
...
INSERT INTO delivery_settings(id, price_per_km, minimum_fee, free_radius_km, notes)
